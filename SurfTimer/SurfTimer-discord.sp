...
{
	g_cvWebhook = CreateConVar("sm_surftimer_discord_webhook", "https://discord.com/api/webhooks/867223541005811742/rEbGf-f2VWjZyrhoSeVC4zN-k2tIII8YhbQwBpFXvCbj9-F9O2txI3jghMvCkN6uhWTW", "The webhook to the discord channel where you want record messages to be sent.", FCVAR_PROTECTED);
	g_cvMention = CreateConVar("sm_surftimer_discord_mention", "", "Optional discord mention to notify users.");
