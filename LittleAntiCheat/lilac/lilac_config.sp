...
void lilac_config_setup()
{
	...
	cvar[CVAR_LOG] = CreateConVar("lilac_log", "1",
		...
		FCVAR_PROTECTED, true, 0.0, true, 1.0);
	cvar[CVAR_LOG_EXTRA] = CreateConVar("lilac_log_extra", "2",
	...
	cvar[CVAR_BAN_LANGUAGE] = CreateConVar("lilac_ban_language", "0",
	...
	cvar[CVAR_NOISEMAKER_SPAM] = CreateConVar("lilac_noisemaker", "1",
		...
		FCVAR_PROTECTED, true, -1.0, true, 1.0);
	cvar[CVAR_BACKTRACK_PATCH] = CreateConVar("lilac_backtrack_patch", "1",
	...
	cvar[CVAR_MACRO] = CreateConVar("lilac_macro", "1",
	...
	cvar[CVAR_LOSS_FIX] = CreateConVar("lilac_loss_fix", "1",
		...
		FCVAR_PROTECTED, true, 0.0, true, 1.0);
	cvar[CVAR_AUTO_UPDATE] = CreateConVar("lilac_auto_update", "1",
	...
	if (FileExists("cfg/froidac_config.cfg", false, NULL_STRING))
		AutoExecConfig(true, "froidac_config", "");
	else
		AutoExecConfig(true, "froidac_config", "sourcemod");
}
