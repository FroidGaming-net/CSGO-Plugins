...
#define EXTENSION_ERROR		"This plugin requires one of the cURL or SteamWorks extensions to function."
...
{
	if (!CURL_AVAILABLE() && !STEAMWORKS_AVAILABLE())
	{
...
// #endif
	...
	_hUpdateTimer = CreateTimer(1800.0, Timer_CheckUpdates, _, TIMER_REPEAT);
}
