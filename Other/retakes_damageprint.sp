...
public Plugin myinfo = {
    name = "CS:GO Retakes: damage printer",
...
public Action Event_RoundEnd(Event event, const char[] name, bool dontBroadcast) {
  if (!Retakes_Live() || g_hEnabled.IntValue == 0)
    return;
